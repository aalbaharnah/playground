...
type GLTFResult = GLTF & {
    nodes: {
        Bike: THREE.Mesh, Cube: THREE.Mesh, Cylinder002_1: THREE.Mesh, Cylinder002_2: THREE.Mesh, Cylinder006: THREE.Mesh, Cylinder006_1: THREE.Mesh, Torus003: THREE.Mesh, Torus003_1: THREE.Mesh, Torus003_2: THREE.Mesh, Cylinder004: THREE.Mesh, Cylinder004_1: THREE.Mesh, CaboFreioFrente: THREE.Mesh, Cylinder001: THREE.Mesh, Cylinder005: THREE.Mesh, Cylinder005_1: THREE.Mesh, Cylinder011: THREE.Mesh, Cylinder011_1: THREE.Mesh, Cylinder_1: THREE.Mesh, Cylinder_2: THREE.Mesh, Torus002: THREE.Mesh, Torus002_1: THREE.Mesh, Torus002_2: THREE.Mesh, NurbsCurve: THREE.Mesh, Sphere002: THREE.Mesh, Cylinder010: THREE.Mesh, Cylinder010_1: THREE.Mesh, Cylinder007: THREE.Mesh, Cylinder007_1: THREE.Mesh, Cylinder008: THREE.Mesh, Cylinder008_1: THREE.Mesh, Sphere: THREE.Mesh, B_Raios: THREE.Mesh, F_Raios: THREE.Mesh

    }
    materials: {
        Quadro: THREE.MeshStandardMaterial, Pneu: THREE.MeshStandardMaterial, Eixo: THREE.MeshStandardMaterial, Roda: THREE.MeshStandardMaterial, Faixa: THREE.MeshStandardMaterial, PedalInterno: THREE.MeshStandardMaterial, PedalExterno: THREE.MeshStandardMaterial, Raio: THREE.MeshStandardMaterial
    }
}
...
export default function BicycleModel(props: BearProps) {
    const ref = useRef<THREE.Group>(null)

    const { nodes, materials } = useGLTF(require('../../../assets/models/bicycle.gltf')) as unknown as GLTFResult;

    useFrame((state, delta) => {

        if (props.x) {
            ref.current?.rotateY(props.x.value / 800)
        }
